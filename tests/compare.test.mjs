...
ok("primary score normalized to /100 (layered capPct, legacy fallback)", HTML.includes("layers2 ? report.capPct : report.score") && HTML.includes("' / ' + (layers2 ? 100 : (report.scoreMax || 100))"));
